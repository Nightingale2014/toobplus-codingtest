...
프론트엔드 코딩 테스트 과제로 진행한 **React 기반 프로젝트**입니다.  
제공된 코딩 테스트 매뉴얼을 기준으로 요구사항을 충족하는 방향으로  
구조 설계 및 기능 구현을 진행했습니다.
...
images/
코딩 테스트 매뉴얼에서 제공된 아이콘 및 이미지 리소스를
정리해 관리했습니다.
...
본 프로젝트는 React 기반으로 작성되었습니다.

npm install
npm start


의존성 설치 후 npm start 실행 시
로컬 개발 서버를 통해 화면을 확인할 수 있습니다.
...
제출용 결과물은 build/index.html 기준으로 확인할 수 있습니다.

로컬 개발 환경에서는 npm start로 화면을 확인했습니다.
